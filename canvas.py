...
class Canvas ( ) :
    ...
    def __init__ (self , width , height) :
        ...
        self.color = "BLUE"  # only really used to initialize lines
        self.lines = { }
        self.currLine = None
    ...
    def draw_dashboard (self , frame , gesture="HOVER" , point=(-1 , -1)) :
        ...
        clear_button_height = int ( frame_height * .10 )  # all button take up 15% of screen height
        width_border = int ( clear_button_width * .03 )  # 5% padding in both directions
        height_border = int ( clear_button_height * .03 )
        ...
        cv.putText ( frame , f"Mode: {gesture}" ,
                     ...
                     cv.FONT_HERSHEY_SIMPLEX ,
                     1 , self.colors [ self.color ] , 2 , cv.LINE_AA )
